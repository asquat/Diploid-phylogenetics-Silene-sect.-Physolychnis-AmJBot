# Written by Bengt Oxelman in 2023, commented by Anne-Sophie Quatela
...
# count files. Input files are multiple alignments (MSA).
fcount = 0
...
for path in os.listdir(directory):
    ...
    # check if current path is a file
         ...
         if os.path.isfile(os.path.join(directory, path)):
            fcount += 1
nsamp=85 # Update according to the number samples in your MSA.
